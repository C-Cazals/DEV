...
printf,unit_rank, bnames[tab_band]
 ...
 ; print,'Tab_band avant le while',tab_band
  ...
  count_step_it = 0
  While nb_temp lt nb do begin ; tant que le nombre de paramètre est inférieur au nombre de paramètres total
...
;      count_step_it = 0
;    endif
    if (full_greedy eq 1 and count_step_it eq 0) then begin ; valable uniquement à la première itération, permet de choisir la première bande.
