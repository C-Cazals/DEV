...
int main(int argc, char **argv)
{
	...
	Npolar = parse_command_line(argc, argv, input_file_name, model_file_name); /* Number of polarimetric indices used for the classification */
...
/*	strcpy(input_file_name, argv[argc-3]);
	if(input_file_name==NULL)
	{
		fprintf(stderr,"can't open inpufile %s\n", argv[argc-3]);
		exit(1);
	}*/
